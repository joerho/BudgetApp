...
class Transaction {
    ...
    init(id: Int64? = nil, description: String = "", date: String = "", amount: NSDecimalNumber? = nil, category: String? = Category.misc.rawValue, repeats: String = RepeatFrequency.never.rawValue) {
        self.id = id
